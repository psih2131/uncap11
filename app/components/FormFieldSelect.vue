  ...
  >
    ...
    >
      <span
        ...
        :class="{
          'payment-form-field__select-value--placeholder': !modelValue,
        }"
      >
      ...
      <div v-show="isOpen" class="payment-form-field__select-dropdown">
        <button
          ...
          :class="{
            'payment-form-field__select-option--active':
        ...
        >
          <span>{{ opt.label }}</span>
          <span
            v-if="opt.discount != null"
            class="payment-form-field__select-option-sale"
          >
            -{{ opt.discount }}%
          </span>
        </button>
